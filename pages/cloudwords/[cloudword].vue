...
loading.value = true
const { data: words } = await useFetch<WordSetItemDTO[]>(getWordCloud(cloudwordSlug))
data.value = words
...
<template>
  <div class="word-cloud-wrapper">
    ...
    <vue-word-cloud v-if="filteredWords && filteredWords?.length" :words="filteredWords" font-family="Roboto"
      :font-size-ratio="5" :animation-duration="100" :color="(value: Array<number | string>) => getColorByWeight(value)"
      style="height: 90%; place-self: center;">
